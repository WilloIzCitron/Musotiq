...
module.exports.run = async (bot, message, args, color, distube) => {
    ...
    if(!reportbug) return message.channel.send("You didnt type a suggestion!");
    ...
    .setColor(color)
	.setFooter(`Suggestion sent by ${message.author.tag}`)
    .setTimestamp()
    bot.channels.cache.get('837498640301162536').send({ embeds: [suggestionembedgay] })
}
